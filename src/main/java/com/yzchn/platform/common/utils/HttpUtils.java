...
public class HttpUtils {
     ...
     *
     * @param url   发送请求的 URL
     * @param param 请求参数，请求参数应该是 name1=value1&name2=value2 的形式。可为null。
     * @return 所代表远程资源的响应结果
     */
    ...
    public static String sendPost(String url, String param) {
        ...
        try {
            ...
            throw new BusinessException(BusinessEnum.UNLOCK_FAIL);
        } finally {
            closeQuietly(out);
            closeQuietly(in);
    ...
    public static HttpResponse doPost(String host, String path, String method,
        ...
        if (StringUtils.isObjectNotEmpty(body)) {
    ...
    private static String buildUrl(String host, String path, Map<String, String> querys) throws UnsupportedEncodingException {
        ...
        sbUrl.append(host);
        if (!StringUtils.isObjectNotEmpty(path)) {
            sbUrl.append(path);
        }
        if (null != querys) {
            ...
            for (Map.Entry<String, String> query : querys.entrySet()) {
                ...
                if (StringUtils.isObjectNotEmpty(query.getKey()) && !StringUtils.isObjectNotEmpty(query.getValue())) {
                    sbQuery.append(query.getValue());
                }
                if (!StringUtils.isObjectNotEmpty(query.getKey())) {
                    sbQuery.append(query.getKey());
                    if (!StringUtils.isObjectNotEmpty(query.getValue())) {
                        sbQuery.append("=");
