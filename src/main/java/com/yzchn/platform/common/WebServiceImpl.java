package com.yzchn.platform.common;
 ...
 * @author 洛无异
 * @version 1.0.0
 * @ClassName WebServiceImpl.java
 * @Description TODO
 * @createTime 2021年06月22日 17:26:00
 */
@SuppressWarnings("unchecked")
public class WebServiceImpl<M extends BaseMapper<T>, T> implements IService<T> {
